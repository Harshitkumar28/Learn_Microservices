...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    //This method is provided by ResponseEntityExceptionHandler and we have to override this method here
    @Override
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        validationErrorList.forEach((error) -> {
            ...
            String validationMsg = error.getDefaultMessage(); // same message will be delivered here what we've written in DTOs
