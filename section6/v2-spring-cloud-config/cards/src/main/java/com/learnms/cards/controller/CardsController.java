...
import com.learnms.cards.dto.CardsContactInfoDto;
import com.learnms.cards.dto.CardsDto;
import com.learnms.cards.dto.ErrorResponseDto;
 ...
 */
@Tag(
        name = "CRUD REST APIs for Cards in blood bank",
        description = "CRUD REST APIs in BloodBank to CREATE, FETCH and DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside BloodBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
